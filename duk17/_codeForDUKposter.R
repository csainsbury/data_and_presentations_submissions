...
plotfilename <- paste("./DUKdPresentationPlots.pdf",sep="")
...
# all admissions
admissionDbox<-boxplot(reportingDF$admissionDurationDays ~ cut(reportingDF$lastHbA1cInFrame,breaks=seq(30,200,10)),las=3,varwidth=T,ylim=c(0,5),plot=T,main="admission duration vs last measured HbA1c value. increments of 10mmol/mol")
